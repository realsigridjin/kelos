...
type SessionLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha2.Session, err error)
...
type sessionLister struct {
	listers.ResourceIndexer[*apiv1alpha2.Session]
}

// NewSessionLister returns a new SessionLister.
func NewSessionLister(indexer cache.Indexer) SessionLister {
	return &sessionLister{listers.New[*apiv1alpha2.Session](indexer, apiv1alpha2.Resource("session"))}
}

// Sessions returns an object that can list and get Sessions.
func (s *sessionLister) Sessions(namespace string) SessionNamespaceLister {
	return sessionNamespaceLister{listers.NewNamespaced[*apiv1alpha2.Session](s.ResourceIndexer, namespace)}
}
...
type SessionNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha2.Session, error)
