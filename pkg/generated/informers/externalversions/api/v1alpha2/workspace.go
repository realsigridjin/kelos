...
type WorkspaceInformer interface {
	...
	Lister() apiv1alpha2.WorkspaceLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApiV1alpha2().Workspaces(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha2().Workspaces(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha2().Workspaces(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha2().Workspaces(namespace).Watch(ctx, options)
			},
		}, client),
		&kelosapiv1alpha2.Workspace{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workspaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kelosapiv1alpha2.Workspace{}, f.defaultInformer)
}

func (f *workspaceInformer) Lister() apiv1alpha2.WorkspaceLister {
	return apiv1alpha2.NewWorkspaceLister(f.Informer().GetIndexer())
}
