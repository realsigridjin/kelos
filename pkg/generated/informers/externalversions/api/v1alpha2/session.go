...
type SessionInformer interface {
	...
	Lister() apiv1alpha2.SessionLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApiV1alpha2().Sessions(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha2().Sessions(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha2().Sessions(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha2().Sessions(namespace).Watch(ctx, options)
			},
		}, client),
		&kelosapiv1alpha2.Session{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sessionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kelosapiv1alpha2.Session{}, f.defaultInformer)
}

func (f *sessionInformer) Lister() apiv1alpha2.SessionLister {
	return apiv1alpha2.NewSessionLister(f.Informer().GetIndexer())
}
