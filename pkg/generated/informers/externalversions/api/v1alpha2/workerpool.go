...
type WorkerPoolInformer interface {
	...
	Lister() apiv1alpha2.WorkerPoolLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApiV1alpha2().WorkerPools(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha2().WorkerPools(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha2().WorkerPools(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha2().WorkerPools(namespace).Watch(ctx, options)
			},
		}, client),
		&kelosapiv1alpha2.WorkerPool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workerPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kelosapiv1alpha2.WorkerPool{}, f.defaultInformer)
}

func (f *workerPoolInformer) Lister() apiv1alpha2.WorkerPoolLister {
	return apiv1alpha2.NewWorkerPoolLister(f.Informer().GetIndexer())
}
